    ...
    <>
      ...
      <nav className={`navbar ${scrolled ? "scrolled" : ""}`} id="navbar">
        <Link href="/" className="navbar-logo" aria-label="eu+fitness home" style={{ display: "flex", alignItems: "center" }}>
          <Image src="/logo_transparent.png" alt="eu+fitness logo" width={150} height={40} style={{ objectFit: "contain" }} priority />
        </Link>
        ...
        <div className="footer-grid">
          <div>
            <span className="footer-logo" style={{ display: "inline-block", marginBottom: "16px" }}>
              <Image src="/logo_transparent.png" alt="eu+fitness logo" width={150} height={40} style={{ objectFit: "contain", objectPosition: "left" }} />
            </span>
